...
function getOrderGoodsRefundBalance(order_goods_id){
	if(order_goods_id != ""){
		$.ajax({
			type : "post",
			async : false,
			url : __URL(ADMINMAIN + "/servicesorder/getordergoodsrefundbalance"),
...
function orderGoodsRefundMoney(order_goods_id){
	$.ajax({
		url : __URL(ADMINMAIN + "/servicesorder/ordergoodsrefundmoney"),
		type : "post",
		data : { "order_goods_id" : order_goods_id},
...
function getOrderTermsOfPayment(order_id){
	if(order_id != ""){
		$.ajax({
			type : "post",
			async : false,
			url : __URL(ADMINMAIN + "/servicesorder/getordertermsofpayment"),
...
//	console.log(order_id+","+order_goods_id+","+refund_money+","+refund_balance_money);
	...
	$.ajax({
		type : "post",
		url : __URL(ADMINMAIN + "/servicesorder/ordergoodsconfirmrefund"),
...
function checkPayConfigEnabled(){
	...
	if(type != ""){
		$.ajax({
			type : "post",
			url : __URL(ADMINMAIN + "/servicesorder/checkpayconfigenabled"),
			data : { "type" : type },
			success : function(res){
...
function agreeRefund(){
	...
	$.ajax({
		type : "post",
		url : __URL(ADMINMAIN + "/servicesorder/ordergoodsrefundagree"),
