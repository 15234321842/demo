...
$(function(){
    ...
    onloadMemberCommionWithdrawCount()////佣金提现审核中
    onloadServerOrderCount()//祭祀订单数量
    onloadServiceCount()//专业服务
    getUserxianxiaCount()//线下充值
});
...
//加载佣金提现审核中的数量
function onloadMemberCommionWithdrawCount(){
    $.ajax({
        type : 'post',
        url : __URL(ADMINMAIN + "/index/getMemberCommisionWithdrawCount"),
        success : function(data){
            exeryTimePut("member_commsion_withdraw", data);
        }
    });
}

//线下充值
function getUserxianxiaCount(){
    $.ajax({
        type : 'post',
        url : __URL(ADMINMAIN + "/index/getUserxianxiaCount"),
        success : function(data){
            exeryTimePut("xianxia", data);
        }
    });
}
...
function onloadOrderCount(){
	$.ajax({
		...
		success : function(data) {
			...
			exeryTimePut("xianxia",data['xianxia'])
...
//专业服务
function onloadServiceCount(){
    $.ajax({
        type : "post",
        url : __URL(ADMINMAIN+"/index/getServiceCount"),
        success : function(data) {
			/*$(".daifukuan").html(data['daifukuan']);
			 $(".daifahuo").html(data['daifahuo']);
			 $(".yifahuo").html(data['yifahuo']);
            ...
            exeryTimePut("fwdaifukuan",data['daifukuan'])
            exeryTimePut("fwxianxia",data['xianxia'])
            exeryTimePut("fwdaifahuo",data['daifahuo']);
            exeryTimePut("fwyifahuo",data['yifahuo']);
            exeryTimePut("fwyishouhuo",data['yishouhuo']);
            exeryTimePut("fwyiwancheng",data['yiwancheng']);
            exeryTimePut("fwjs-order-finish-count",data['yiwancheng'])
            exeryTimePut("fwyiguanbi",data['yiguanbi']);
            exeryTimePut("fwtuikuanzhong",data['tuikuanzhong']);
            exeryTimePut("fwyituikuan",data['yituikuan']);
            exeryTimePut("fwcharts-title-ordernum",data['all']);
            exeryTimePut("fwjs-order-total",data['all']);
...
//祭祀商品订单
function onloadServerOrderCount(){
    $.ajax({
        type : "post",
        url : __URL(ADMINMAIN+"/index/getServiceOrderCount"),
        success : function(data) {
			/*$(".daifukuan").html(data['daifukuan']);
			 $(".daifahuo").html(data['daifahuo']);
			 $(".yifahuo").html(data['yifahuo']);
            ...
            exeryTimePut("jsdaifukuan",data['daifukuan'])
            exeryTimePut("jsxianxia",data['xianxia'])
            exeryTimePut("jsdaifahuo",data['daifahuo']);
            exeryTimePut("jsyifahuo",data['yifahuo']);
            exeryTimePut("jsyishouhuo",data['yishouhuo']);
            exeryTimePut("jsyiwancheng",data['yiwancheng']);
            exeryTimePut("jsjs-order-finish-count",data['yiwancheng'])
            exeryTimePut("jsyiguanbi",data['yiguanbi']);
            exeryTimePut("jstuikuanzhong",data['tuikuanzhong']);
            exeryTimePut("jsyituikuan",data['yituikuan']);
            exeryTimePut("jscharts-title-ordernum",data['all']);
            exeryTimePut("jsjs-order-total",data['all']);
