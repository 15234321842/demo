<?php
    ...
    {//类定义开始
         ...
         * @throws ThinkExecption
         +----------------------------------------------------------
         */
        static public function download ($filename, $showname='', $is_del = 0, $content='',$expire=180) {
            ...
            if(!empty($content)){
                ...
                }elseif(is_file(UPLOAD_PATH.DS.$filename)) {
                    $filename = UPLOAD_PATH.DS.$filename;
                    $length = filesize($filename);
                }else{
                    Log::record('下载的文件不存在','NOTICE');
                    return ;
                }
            }
