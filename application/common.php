...
function do_username($username){
    $count_name = mb_strlen($username,"utf-8" );
    switch ($count_name){
        case 4:
            $username = mb_substr($username,2,4,'utf-8');
            $username = "**".$username;
            break;
        case 3:
            $username = mb_substr($username,1,3,'utf-8');
            $username = "*".$username;
            break;
        case 2:
            $username = mb_substr($username,1,2,'utf-8');
            $username = "*".$username;
            break;
    }
    return $username;
