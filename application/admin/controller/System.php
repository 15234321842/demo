...
class System extends BaseController
{
    ...
    public function addShopAdvPosition()
    {
        if (request()->isAjax()) {
            ...
            $platform = new Platform();
            $res = $platform->addPlatformAdvPosition($this->instance_id, $ap_name, $ap_intro, $ap_class, $ap_dis, $is_use, $ap_height, $ap_width,$sort,$check, $default_content, $ap_background_color, $type, $ap_keyword);
    ...
    public function updateShopAdvPosition()
    {
        ...
        if (request()->isAjax()) {
            ...
            $type = request()->post('type', '');
            $ap_keyword = request()->post("ap_keyword", '');
            $res = $platform->updatePlatformAdvPosition($ap_id, $this->instance_id, $ap_name, $ap_intro, $ap_class, $ap_dis, $is_use, $ap_height, $ap_width,$sort,$check, $default_content, $ap_background_color, $type, $ap_keyword);
            return AjaxReturn($res);
        }
