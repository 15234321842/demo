...
use data\service\PositionsBrand as GoodsBrand;
use data\service\PositionsCategory as GoodsCategory;
use data\service\PositionsGroup as GoodsGroup;
...
class Positions extends BaseController
{
     ...
     *
     * @return \data\model\shop\NsGoodsModel
     */
    ...
    public function goodsList()
    {
        ...
        if (request()->isAjax()) {
            ...
            $child_menu_list = array(
                array(
                    'url' => "positions/goodslist",
                    'menu_name' => "福位列表",
                    "active" => 1
                ),
                array(
                    'url' => "positions/recyclelist",
                    'menu_name' => "福位回收站",
                    "active" => 0
                )
            );
            ...
            return view($this->style . "Positions/goodsList");
        }
    }
    ...
    public function addGoods()
    {
        ...
        if ($goodsId > 0) {
            ...
            if (! empty($goods_info)) {
                ...
                return view($this->style . "Positions/selectCategoryNextUpdate");
            } else {
                $this->error("商品不存在");
            }
        } else {
            return view($this->style . 'Positions/selectCategoryNext');
        }
    }
    ...
    {
        return view($this->style . "Positions/addGoods");
    }
    ...
    public function goodsBrandList()
    {
        if (request()->isAjax()) {
            ...
            return view($this->style . "Positions/goodsBrandList");
        }
    }
    ...
    public function addGoodsBrand()
    {
        if (request()->isAjax()) {
            ...
            return view($this->style . "Positions/addGoodsBrand");
        }
    }
    ...
    public function updateGoodsBrand()
    {
        ...
        if (request()->isAjax()) {
            ...
            return view($this->style . "Positions/editGoodsBrand");
        }
    }
    ...
    public function goodsCategoryList()
    {
        ...
        return view($this->style . "Positions/goodsCategoryList");
    }
    ...
    public function addGoodsCategory()
    {
        ...
        if (request()->isAjax()) {
            ...
            return view($this->style . "Positions/addGoodsCategory");
        }
    }
    ...
    public function updateGoodsCategory()
    {
        ...
        if (request()->isAjax()) {
            ...
            return view($this->style . "Positions/updateGoodsCategory");
        }
    }
...
$product['goods_attribute_id'], $product['goods_attribute'], $product['goods_spec_format'], $product['goods_weight'], $product['goods_volume'], $product['shipping_fee_type'], $product['categoryExtendId'], $product["sku_picture_vlaues"], $product['virtual_goods_type_id'], $product['production_date'], $product['shelf_life'], $product['ladder_preference'], $product['goods_video_address']);
            ...
            if ($res > 0 && $qrcode == 1) {
                ...
                $url = __URL(Config::get('view_replace_str.APP_MAIN') . '/positions/goodsdetail?id=' . $goodsId);
    ...
    public function goodsGroupList()
    {
        if (request()->isAjax()) {
            ...
            return view($this->style . "Positions/goodsGroupList");
        }
    }
    ...
    public function addGoodsGroup()
    {
        ...
        if (request()->isAjax()) {
            ...
            return view($this->style . "Positions/addGoodsGroup");
        }
    }
    ...
    public function updateGoodsGroup()
    {
        ...
        if (request()->isAjax()) {
            ...
            return view($this->style . "Positions/updateGoodsGroup");
        }
    }
    ...
    public function goodsSpecList()
    {
        ...
        return view($this->style . 'Positions/goodsSpecList');
    }
    ...
    public function addGoodsSpec()
    {
        ...
        return view($this->style . 'Positions/addGoodsSpec');
    }
    ...
    public function updateGoodsSpec()
    {
        ...
        return view($this->style . 'Positions/updateGoodsSpec');
    }
    ...
    public function attributelist()
    {
        ...
        return view($this->style . "Positions/attributelist");
    }
    ...
    public function addAttributeService()
    {
        ...
        return view($this->style . 'Positions/addGoodsAttribute');
    }
    ...
    public function updateGoodsAttribute()
    {
        ...
        return view($this->style . 'Positions/updateGoodsAttribute');
    }
    ...
    public function goodscomment()
    {
        ...
        return view($this->style . "Positions/goodsComment");
    }
    ...
    public function controlDialogSku()
    {
        ...
        $this->assign("attr_id", $attr_id);
        return view($this->style . 'Positions/controlDialogSku');
    }
    ...
    public function recycleList()
    {
        if (request()->isAjax()) {
            ...
            return view($this->style . 'Positions/recycleList');
        }
    }
    ...
    public function copyGoods()
    {
        ...
        if ($res > 0) {
            ...
            $url = Config::get('view_replace_str.APP_MAIN') . '/Positions/goodsDetail?id=' . $goodsId;
            $pay_qrcode = getQRcode($url, 'upload/goods_qrcode', 'goods_qrcode_' . $goodsId);
    ...
    public function dialogSelectCategory()
    {
        ...
        return view($this->style . 'Positions/dialogSelectCategory');
    }
    ...
    public function updateGoodsQrcode()
    {
        ...
        if (! empty($goods_ids) && is_array($goods_ids)) {
            foreach ($goods_ids as $v) {
                $url = __URL(Config::get('view_replace_str.APP_MAIN') . '/positions/goodsdetail?id=' . $v);
                try {
    ...
    public function virtualGoodsTypeList()
    {
        ...
        return view($this->style . 'Positions/virtualGoodsTypeList');
    }
    ...
    public function editVirtualGoodsType()
    {
        ...
        return view($this->style . "Positions/editVirtualGoodsType");
    }
