<?php /*a:4:{s:69:"D:\phpstudy_pro\WWW\letucrm\app_www\houtai\view\crm_follow\index.html";i:1576676556;s:70:"D:\phpstudy_pro\WWW\letucrm\app_www\houtai\view\common\common_css.html";i:1576676556;s:70:"D:\phpstudy_pro\WWW\letucrm\app_www\houtai\view\common\bottom_nav.html";i:1576676556;s:69:"D:\phpstudy_pro\WWW\letucrm\app_www\houtai\view\common\common_js.html";i:1576676556;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <div class="weui-cell weui-cell_access">
                            <div class="weui-cell__bd">
                                <div class="weui-cell__ft">
                                    <a href="<?php echo letu_url('view',array('id'=>think_encrypt($vo['follow_id']))); ?>">
                                        <p class="clue_content"><?php echo htmlentities($vo['follow_log']); ?></p>
                                    </a>
                                    <p class="clue_time">
                                        <span><?php echo htmlentities(date('Y-m-d',!is_numeric($vo['follow_time'])? strtotime($vo['follow_time']) : $vo['follow_time'])); ?></span>
                                        <span style="margin-left: 10px;" class="weui-badge"><?php echo config('app.follow_type.'.$vo['follow_type']); ?></span>
        ...
        <form id="frmSearch" method="post">
            <div class="weui-cells weui-cells_form letu-cells_not_top_line">
                ...
                <div class="weui-cell">
                    ...
                    <div class="weui-cell__bd">
                        <input type="text" id="follow_time" name="follow_time" class="weui-input" placeholder="请选择日期" maxlength="20" />
                    </div>
                </div>
                <div class="weui-cell">
                    <div class="weui-cell__bd">
                        <div class="letu-box">
                            ...
                            <div class="letu-box-body weui-cells_checkbox">
                                <?php if(is_array($followTypeList) || $followTypeList instanceof \think\Collection || $followTypeList instanceof \think\Paginator): $i = 0; $__LIST__ = $followTypeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <label class="letu-radio-inline weui-check__label">
                                    <div class="weui-cell__hd">
                                        <input type="radio" name="follow_type" class="weui-check" value="<?php echo htmlentities($key); ?>"/>
        ...
        <div class="weui-cell__bd">
            <div class="weui-cell__ft">
                ...
                <p class="clue_time">
                    ...
                    <span style="margin-left: 10px;" class="weui-badge">{{follow_type_text}}</span>
...
<script type="text/javascript">
    ...
    function update_search_params(){
        ...
        param_json.follow_time = $("#follow_time").val();

        var $follow_type = $("input[name='follow_type']:checked");
        if($follow_type.prop("checked")){
            param_json.follow_type = $follow_type.val();
        }else{
            delete param_json['follow_type'];
        }
    }
