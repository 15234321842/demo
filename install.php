 ...
 * shop商城系统
 * =========================================================
 * Copy right 2015-2025 河南比古科技有限公司, 保留所有权利。
 * ----------------------------------------------
 * 官方网址: http://www.easybigu.com
 * 
 * 非授权用户允许商用，严禁去除shop相关的版权信息。
 * 请尊重shop开发人员劳动成果，严禁使用本系统转卖、销售或二次开发后转卖、销售等商业行为。
...
if(file_exists(IA_ROOT . '/install1.lock') && $action != 'finish') {
		...
		if(strstr(PHP_VERSION, '7.'))
		{
    		...
    		if(empty($error)) {
     		...
     		if(empty($error)) {
                ...
                //循环添加数据
                if(file_exists(IA_ROOT . '/bigu.sql')){
                    ...
                    $sql = file_get_contents(IA_ROOT . '/bigu.sql');
                    $sql = str_replace("\r", "\n", $sql);
                    $sql = explode(";\n", $sql);
		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation" class="active"><a href="javascript:;">安装shop商城</a></li>
				</ul>
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a  target = "_blank" href="http://www.easybigu.com">shop商城官网</a> &nbsp;
				</div>
				<div class="text-center">
					Powered by <a   target = "_blank" href="http://www.easybigu.com"><b>shop商城</b></a> niu_version &copy; 2015-2025 <a target = "_blank" href="http://www.easybigu.com">http://www.easybigu.com</a>
				</div>
			</div>
		</div>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2016，shop商城团队保留所有权利。 </h3>
				<p>
					感谢您选择shop商城（以下简称shop）shop基于 PHP + MySQL的技术开发，全部源码开放。 <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于shop商城系统(以下简称shop)任何版本，shop商城官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					...
					<ol>
						...
						<li>您可以在协议规定的约束和限制范围内修改shop商城源代码或界面风格以适应您的网站要求。</li>
				...
				<p>
					...
					<ol>
						...
						<li>未经官方许可，禁止在shop商城的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
				...
				<p>
					...
					<ol>
						...
						<li>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装  shop，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</li>
...
function tpl_install_env($ret = array()) {
	...
	echo <<<EOF
		...
		<div class="alert alert-info">系统要求shop商城安装目录下的runtime和upload必须可写, 才能使用shop商城所有功能。</div>
		<div class="panel panel-default">
...
function tpl_install_db($error = '') {
	...
	$insTypes = array();
	if(file_exists(IA_ROOT . '/index') && is_dir(IA_ROOT . '/app') && is_dir(IA_ROOT . '/web')) {
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<!-- <div class="help-block">
							...
							在线安装能够直接安装最新版本shop商城系统, 如果在线安装困难, 请下载离线安装包后使用本地安装. <br/>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" type="text" name="db[name]" id="dbname" value="bigu">
					</div>
				</div>
			</div>
		</div>
...
// 	$themes = get_store_theme();
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“shop商城”系统，您现在可以: 
		<!--<a target="_blank" class="btn btn-success" href="./index1.html">访问网站首页</a>-->
